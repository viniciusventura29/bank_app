...
<footer className="p-4 bg-white mt-16 rounded-t-lg shadow md:px-6 md:py-8 dark:bg-gray-900">
    ...
    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">Brand™</a>. All Rights Reserved.
    </span>
</footer>
